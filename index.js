...
export async function init(){ if(initialized)return; initialized=true; await loadDocs(); shell(); render(); console.log('[ST Reference Desk] ready v0.1.0'); }
